# ENTITY Subsystem Requirements — Policy Engine
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `01_Core_Runtime/policy_engine`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Evaluate machine-readable permissions, prohibitions, duties and constraints, including AI use, retention, deletion, sublicensing, territory, duration and payment.
