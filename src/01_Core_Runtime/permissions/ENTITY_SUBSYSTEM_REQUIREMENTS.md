# ENTITY Subsystem Requirements — Runtime Permissions
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `01_Core_Runtime/permissions`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Implement fail-closed policy authorization over actor, role, capability, asset, action, purpose, policy, jurisdiction, approval threshold, time and counterparty.
