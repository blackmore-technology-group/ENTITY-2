...
## Subsystem Purpose
Provide algorithm-identified, crypto-agile signing, hashing, verification, rotation and revocation interfaces. No durable schema may assume one permanent algorithm.
