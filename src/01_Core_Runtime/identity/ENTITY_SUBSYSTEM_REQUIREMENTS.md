# ENTITY Subsystem Requirements — Sovereign Identity
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `01_Core_Runtime/identity`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Implement stable root identity, operational key separation, pairwise identities, recovery, succession and threshold organizational authority.
