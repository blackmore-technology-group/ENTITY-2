# ENTITY Subsystem Requirements — Migration
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `15_Operations/migration`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Migrations must preserve signed historical meaning, record source/target versions and roots, and be independently verifiable.
