# ENTITY Subsystem Requirements — Recovery
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `15_Operations/recovery`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Recovery must restore identity, assets, rights, policies, ledger, contracts and economic records and must support device/key loss scenarios.
