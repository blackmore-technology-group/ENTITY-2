# ENTITY Subsystem Requirements — Telemetry
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `15_Operations/telemetry`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Collect operational metrics with privacy minimization and no unnecessary content or globally correlatable identity exposure.
