# ENTITY Subsystem Requirements — Rights & Claims Graph
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `04_Entity_Registry/ownership_graphs`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Replace simplistic ownership with many-to-many rights claims including legal basis, evidence, shares, scope, territory, verification and dispute state.
