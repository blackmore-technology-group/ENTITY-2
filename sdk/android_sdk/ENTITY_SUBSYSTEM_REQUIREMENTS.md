# ENTITY Subsystem Requirements — Android SDK
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `14_Protocols_SDK/android_sdk`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Expose versioned, least-privilege ENTITY APIs and secure key/device integration while preserving platform-independent signed semantics.
