# ENTITY Subsystem Requirements — Web SDK
Source: SERS-ENTITY-001 — Target Architecture v1.0
Repository scope: `14_Protocols_SDK/web_sdk`
Status: Active engineering requirement
Cross-stream contract: `docs/requirements/CROSS_IMPLEMENTATION_COMPATIBILITY.md`

## Subsystem Purpose
Expose browser-safe, explicit scopes and secure transport without giving web contexts ambient access to vault or root authority.
